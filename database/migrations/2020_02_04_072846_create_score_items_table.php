...
class CreateScoreItemsTable extends Migration
{
    ...
    public function up()
    {
        ...
        addItem("DESGN", "Quantitative Measure (95%)", "Efficiency", "Design Churn", "Refer to Tier", "Churn", 25, "X");
        addItem("DESGN", "Quantitative Measure (95%)", "Efficiency", "Attendance Rate (actual score - individual)", "95%", "Attendance", 15, "AB");
        addItem("DESGN", "Quantitative Measure (95%)", "Product Knowledge", "Product Knowledge Test (actual score)", "80%", "PKT", 20, "AC");
        addItem("DESGN", "Qualitative Measure (5%)", "Bonus", "1. Admin task assignments (1st & 2nd assistants only)\n2. Commendation from the client\n3. Issue identifier (client-approved)\n4. Issue resolver (client-approved)\n5. Innovation ideas implemented on a Personiv (approved by Paulo) and/or DexYP level (approved by client).\n6. OM Initiated (core-team approved)", "Met 1", "Bonus", 5, "AF");
    }
