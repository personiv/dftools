                    ...
                    <div class="col-sm">
                        <div class="eachScore-container px-4 py-3">
                            ...
                            <div class="progress mt-1">
                                ...
                                <span class="progress-title">{{ $scoreItemDetail['score_item_title'] }}: <span class="progress-score">{{ perc($topResource["data"][App\Session::IndexOfCell($scoreItemDetail['score_item_cell'])]) }}%</span></span></div>
                            </div>
                            @endfor
                        </div>
                    </div>
...
@elseif ($user->AccountType() == "MANGR" || $user->AccountType() == "HEAD")
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg">
            <div class="tb-container">
                <div class="dboard-text px-4 pt-4 pb-3">
                    <div class="dboard-title">Teams Summary</div>
                    <div class="dboard-othtext">of Pending and Completed</div>
                </div>
                <div class="dropdown-divider"></div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg">
            <div class="tb-container">
                <div class="dboard-text px-4 pt-4 pb-3">
                    <div class="dboard-title"> Supervisors Summary</div>
                    <div class="dboard-othtext">of Pending and Completed</div>
                </div>
                <div class="dropdown-divider"></div>
                <div class="table-responsive px-4 pt-0 pb-4">
    ...
    <!-- 4th row manager/head dashboard -->
    <div class="row mt-5">
                            ...
                            <div class="table-responsive px-4 pt-0 pb-4">
                                <table class="table table-striped table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $exception_agent = App\Credential::GetCredential($exception->exception_agent) ?>
                                            <tr>
                                                <td>{{ $exception->exception_agent }}</td>
                                                <td>{{ $exception_agent->FullName() }}</td>
                                                <td>{{ $exception_agent->JobPosition() }}</td>
                                                <td>{{ $exception->exception_reason }}</td>
                                                @if ($user->AccountType() == "HEAD")
                                                    <td>{{ $weekSession->Agent()->TeamLeader()->FullName() }}</td>
                                                @endif
